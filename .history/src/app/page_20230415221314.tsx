      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-5 gap-3 mt-4">
            <a className="bg-white/3 p-6 rounded-md flex flex-col gap-2 justify-center items-start hover:bg-white/10">
      ...
      <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="flex gap-6 items-center">
            <ShuffleIcon className="text-zinc-500 hover:text-green-700" size={20} />
            <SkipBack className="text-zinc-500 hover:text-green-700" size={20} />

            <button className="w-10 h-10 flex items-center justify-center pl-1 rounded-full bg-white text-zinc-500 hover:text-green-700">
              <Play size={20} />
            </button>

            <SkipForward className="text-zinc-500 hover:text-green-700" size={20} />
            <Repeat className="text-zinc-500 hover:text-green-700" size={20} />
          </div>
        ...
        <div className="flex items-center gap-2">
          <Mic2 size={20} className="hover:text-green-700"/>
          <LayoutList size={20} className="hover:text-green-700"/>
          <Laptop2 size={20} className="hover:text-green-700"/>
          <div className="flex items-center gap-4">
            <Volume1 size={20} className="hover:text-green-700"/>
            <div className="h-1 rounded-full w-24 bg-zinc-600">
              <div className="h-1 rounded-full w-10 bg-zinc-200 "></div>
            </div>
          </div>
          <Maximize2 size={18} className="hover:text-green-700"/>
        </div>
      </footer>
    </div>
  );
