      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <a
              href=""
              className="bg-white/10 rounded overflow-hidden flex items-center gap-4 group hover:bg-white/20 transition-colors"
            >
              <Image
                src="/1.webp"
                alt="capa de album"
            ...
            <a
              href=""
              className="bg-white/5 rounded overflow-hidden flex items-center gap-4 group hover:bg-white/10 transition-colors"
            >
              <Image
                src="/4.jpg"
                alt="capa de album"
