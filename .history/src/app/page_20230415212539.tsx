      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-5 gap-12 mt-4">
            ...
            <a className='bg-white/5 p-3 rounded flex flex-col justify-center items-center hover:bg-white/10'>
            <Image
                src="/6.png"
                alt="capa de album"
                width={240}
              ...
              <span className='text-xs text-zinc-500'>Little Mix, Pussycat Dolls, Rihanna ....</span>
            </a>
